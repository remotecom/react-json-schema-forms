      ...
      <section style={{ marginTop: "40px" }}>
        ...
        <ul>
          <li>
            ...
            process of adopting JSON schemas, allowing you to quickly integrate
            form rendering and validation based on JSON schemas.
          </li>
          <li>
          ...
          <li>
            <strong>Extensibility:</strong> Partners can use this codebase as a
            starting point to build on top of JSON schemas, customizing it to
        ...
        <ul>
          ...
          <li>
            <strong>Employment Creation:</strong> Shows how to set up employment
            for employees under a created company.
          </li>
          <li>
            <strong>Cost Calculator:</strong> Provides an interface for
            estimating the cost of employment in different countries, including
            salary, benefits, and more.
          </li>
        </ul>
        <p>
          These flows represent the employer's journey up to the point where the
          employee receives a self-enrollment email. After this point, both the
          employer and employee can continue their journey on the Remote
          platform, which handles the ongoing employment relationship,
        ...
        <p>
          ...
          workflows in your own applications, with all the heavy lifting around
        ...
        <p>
          ...
          workflows into your product. By leveraging this codebase, you can
          offer your clients a powerful and compliant experience for managing
