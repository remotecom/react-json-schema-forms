...
const App = () => {
  ...
  const handleInitialFormSubmit = (values) => {
    console.log('Initial Form Submitted:', values);
  ...
  const handleSubmit = async (jsonValues) => {
    try {
      if (!isContractDetails) {
        console.log('Submitting basic employment information:', jsonValues);
        ...
        console.log('Patching contract details:', jsonValues);
